...
If the User wishes to make any use of material on the Website other than that set out in this Section, it should address its request to: contact@Ionic.money.
...
Email to receive **DMCA** notices is: contact@ionic.money
...
All other feedback, comments, requests for technical support, and other communications relating to the Website should be directed to: contact@Ionic.money.
